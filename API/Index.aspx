<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="API.Default" %>
...
input#btnlogin {
    background: -webkit-linear-gradient(right,#fc00ff 25%, #00dbde 25%, #fc00ff 25%, #00dbde );
    height: 53px;
    transition: 20s;
    cursor:pointer;
}
