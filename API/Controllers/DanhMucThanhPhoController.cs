...
{
    public class DanhMucThanhPhoController : ApiController
    {
        [HttpGet]
        public DataTable MucThanhPho()
        {
            ...
            try
            {
                string TenThanhPho = HttpContext.Current.Request.Form["TenThanhPho"];
                ...
                SqlDataAdapter sda = new SqlDataAdapter("MucThanhPho", ketnoi);
